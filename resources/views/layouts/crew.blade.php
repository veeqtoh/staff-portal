    ...
    <body>
                ...
                <div class="sidebar-inner slimscroll">
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li><a class="@if (Route::current()->getName() == 'crew.home') {{'active'}}@endif" href="{{route('crew.home')}}"><i class="la la-dashboard"></i> <span> Dashboard</span> </a></li>
							<li><a class="@if (Route::current()->getName() == 'crew.profile') {{'active'}}@endif" href="{{route('crew.profile')}}"><i class="la la-user"></i> <span> My Profile</span> </a></li>
							{{--<li class="submenu"> 
                            ...
                            <li><a class="@if (Route::current()->getName() == 'crew.reports' || Route::current()->getName() == 'crew.reports.details') {{'active'}}@endif" href="{{route('crew.reports')}}"><i class="la la-pie-chart"></i> <span>Daily Reports</span> </a></li>
                            <li class="submenu">
							...
							<li><a class="@if (Route::current()->getName() == 'crew.salary' || Route::current()->getName() == 'crew.mypayslip') {{'active'}}@endif" href="{{route('crew.salary')}}"><i class="la la-money"></i> <span> My Salary </span> </a></li>
							<li> 
								<a href="{{ route('logout') }}"
        ...
        <div class="header">
            ...
            <div class="header-left">
                <a href="{{route('crew.home')}}" class="logo">
            ...
            <ul class="nav user-menu">
                ...
                <li class="nav-item dropdown has-arrow main-drop">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="{{route('crew.profile')}}">My Profile</a>
