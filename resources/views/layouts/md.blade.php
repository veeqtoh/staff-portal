        ...
        <div class="main-wrapper">
            ...
            <div class="header">
                ...
                <div class="header-left">
                    <a href="{{route('md.home')}}" class="logo">
				...
				<div class="dropdown mobile-user-menu">
					...
					<div class="dropdown-menu dropdown-menu-right">
						<a class="dropdown-item" href="{{route('md.profile')}}">My Profile</a>
						<a class="dropdown-item" href="{{ route('logout') }}"
                                       onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();">Logout</a>
							<form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
                ...
                <div class="sidebar-inner slimscroll">
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li><a class="@if (Route::current()->getName() == 'md.home') {{'active'}}@endif" href="{{route('md.home')}}"><i class="la la-dashboard"></i> <span> Dashboard</span> </a></li>													
							<li><a class="@if (Route::current()->getName() == 'md.profile') {{'active'}}@endif" href="{{route('md.profile')}}"><i class="la la-user"></i> <span> My Profile</span> </a></li>
							{{--<li><a class="@if (Route::current()->getName() == 'md.salary' || Route::current()->getName() == 'md.mypayslip') {{'active'}}@endif" href="{{route('md.salary')}}"><i class="la la-money"></i> <span> My Salary </span> </a></li>--}}
							<li class="menu-title"> 
								<span>Management Information</span>
							</li>
							<li class="submenu"> 
								<a class="@if (Route::current()->getName() == 'reports'|| Route::current()->getName() == 'reports.month' || Route::current()->getName() == 'reports.trashed' || Route::current()->getName() == 'reports.details') {{'active'}} @endif" href="#"><i class="la la-pie-chart"></i> <span>Weekly/Daily Reports</span> 
                                    <span class="menu-arrow"></span>
                                </a>
                                <ul style="display: none;">
									<li><a href="{{route('reports', ['cat' => '6'] )}}"> Staff Reports </a></li>
									<li><a href="{{route('reports', ['cat' => '1'] )}}"> NUE Defender Reports</a></li>
									<li><a href="{{route('reports', ['cat' => '2'] )}}"> SVS Guardsman Reports</a></li>
									<li><a href="{{route('reports', ['cat' => '3'] )}}"> NUE Defender I Reports</a></li>
									<li><a href="{{route('reports', ['cat' => '4'] )}}"> NUE Swift Reports</a></li>
									<li><a href="{{route('reports', ['cat' => '5'] )}}"> NUE Strider Reports</a></li>
									<li><a href="{{route('reports', ['cat' => '7'] )}}"> NUE Lince Reports</a></li>
								</ul>
							</li>
							<li class="menu-title"> 
								<span>HR Duties</span>
							...
							<li class="submenu"> 
                                <a class="@if (Route::current()->getName() == 'md.employees'|| Route::current()->getName() == 'md.employee.profile' || Route::current()->getName() == 'md.employees.trashed') {{'active'}} @endif" href="#"><i class="la la-user"></i> <span>Employees</span> 
                                    <span class="menu-arrow"></span>
                                </a>
                                <ul style="display: none;">
									<li><a href="{{route('md.employees')}}" class="noti-dot">All Employees</a></li>
									<li><a href="{{route('md.employees.trashed')}}">Disabled Accounts</a></li>
								</ul>
							</li>
							<li class="submenu"> 
							...
							<li class="submenu">
								<a href="#" class="@if (Route::current()->getName() == 'md.payroll'|| Route::current()->getName() == 'md.payroll.details'|| Route::current()->getName() == 'md.payslip') {{'active'}}@endif"><i class="la la-money"></i> <span> Generate Salaries </span> <span class="menu-arrow"></span></a>
								<ul style="display: none;">
									<li><a href="{{route('md.payroll', ['cat' => '6'] )}}"> Staff Payroll </a></li>
									<li><a href="{{route('md.payroll', ['cat' => '1'] )}}"> NUE Defender Payroll</a></li>
									<li><a href="{{route('md.payroll', ['cat' => '2'] )}}"> SVS Guardsman Payroll</a></li>
									<li><a href="{{route('md.payroll', ['cat' => '3'] )}}"> NUE Defender I Payroll</a></li>
									<li><a href="{{route('md.payroll', ['cat' => '4'] )}}"> NUE Swift Payroll</a></li>
									<li><a href="{{route('md.payroll', ['cat' => '5'] )}}"> NUE Strider Payroll</a></li>
									<li><a href="{{route('md.payroll', ['cat' => '7'] )}}"> NUE Lince Payroll</a></li>
								</ul>
							</li>
							<li class="submenu">
