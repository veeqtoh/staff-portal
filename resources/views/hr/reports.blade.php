@extends('layouts/crew')
    ...
    @section('title')
		<title>Weekly Reports - N.U.E Offshore Staff Portal</title>
  @endsection
          ...
          <div class="content container-fluid">          
              ...
              <div class="page-header">
                  <div class="row align-items-center">
                      <div class="col">
                          <h3 class="page-title">Weekly Reports</h3>
                          <ul class="breadcrumb">
              ...
              <div class="row staff-grid-row">
                @foreach($months as $num => $month)
                    <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                        ...
                        <h4 class="user-name m-t-10 mb-0 text-ellipsis"><a href="{{route('hr.reports.details', ['cat'=>AUTH::user()->category_id, 'month'=>$month] )}}">{{str_replace('-', ', ', $month)}}</a></h4>
