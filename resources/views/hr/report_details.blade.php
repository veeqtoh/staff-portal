                    ...
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('hr.reports')}}">Weekly Reports</a></li>
                                    ...
                                    <tr>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="{{route('hr.employee.profile', ['slug' => $report->employee->slug] )}}" class="avatar"><img alt="" src="{{$report->employee->profile->avatar}}"></a>
                                                <a href="{{route('hr.employee.profile', ['slug' => $report->employee->slug] )}}">{{$report->employee->f_name}} {{str_limit($report->employee->l_name, $limit = 1, $end = '.')}} <span>{{$report->employee->position->name}}</span></a>
                                            </h2>
                                        </td>
