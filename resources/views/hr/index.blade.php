                    ...
                    <div class="col-md-6 d-flex">
                        <div class="card card-table flex-fill">
                                                ...
                                                <tr>
                                                    <td>
                                                        <h2 class="table-avatar">
                                                            <a href="{{route('hr.employee.profile', ['slug' => $user->slug] )}}" class="avatar"><img alt="" src="{{$user->profile->avatar}}" width="25px" height="40px"></a>
                                                            <a href="{{route('hr.employee.profile', ['slug' => $user->slug] )}}">{{$user->f_name}} {{$user->l_name}}<span>{{$user->position->name}}</span></a>
                                                        </h2>
                                                    </td>
                                                    ...
                                                    <td class="text-right">
                                                        <div class="dropdown dropdown-action">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                <a class="dropdown-item" href="{{route('hr.employee.profile', ['slug' => $user->slug] )}}"><i class="fa fa-pencil m-r-5"></i>Profile</a>
                            ...
                            <div class="card-footer">
                                <a href="{{route('hr.employees')}}">View all employees</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 d-flex">
                        <div class="card card-table flex-fill">
                            ...
                            @else
                            <div class="card-footer">
                                <p>Ain't no one paid salary yet. Click <a href="{{route('hr.payroll', ['cat' => 6] )}}">here</a> to pay salaries</p>
                            </div>
                            @endif
                            </div>
                            <div class="card-footer">
                                <a href="{{route('hr.payroll', ['cat' => 6] )}}">View all payroll</a>
                            </div>
                        </div>
                    </div>
                </div> 
