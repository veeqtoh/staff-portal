@extends('layouts/hr')
    ...
    @section('body')
        ...
        <div class="page-wrapper">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item "><a href="{{route('hr.employees')}}">Employees</a></li>
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="experience-content">
                                                            <div class="timeline-content">
                                                                ...
                                                                <div class="time"><a class="btn btn-sm btn-primary" href="{{asset($employee->profile->coc)}}">Download</a></div></a>                                                            
                                                            </div>
                                                        </div>
                                                    </li>
                                                @endif
                                                @if($employee->profile->med_cert)
                                                    <li>
                                                        <div class="experience-user">
                                                            <div class="before-circle"></div>
                                                        </div>
                                                        <div class="experience-content">
                                                            <div class="timeline-content">
                                                                ...
                                                                <div class="time"><a class="btn btn-sm btn-primary" href="{{asset($employee->profile->med_cert)}}">Download</a></div></a>

                                                            </div>
                                                        </div>
                                                    </li>
                                                @endif
                                                @if($employee->profile->stcw)
                                                    <li>
                                                        <div class="experience-user">
                                                            <div class="before-circle"></div>
                                                        </div>
                                                        <div class="experience-content">
                                                            <div class="timeline-content">
                                                                ...
                                                                <div class="time"><a class="btn btn-sm btn-primary" href="{{asset($employee->profile->stcw)}}">Download</a></div></a>                                                            
                                                            </div>
                                                        </div>
                                                    </li>
                                                @endif
                                                @if($employee->profile->paffp)
                                                    <li>
                                                        <div class="experience-user">
                                                            <div class="before-circle"></div>
                                                        </div>
                                                        <div class="experience-content">
                                                            <div class="timeline-content">
                                                                ...
                                                                <div class="time"><a class="btn btn-sm btn-primary" href="{{asset($employee->profile->paffp)}}">Download</a></div></a>                                                            
                                                            </div>
                                                        </div>
                                                    </li>
                                                @endif
                                                @if($employee->profile->parpo)
                                                    <li>
                                                        <div class="experience-user">
                                                            <div class="before-circle"></div>
                                                        </div>
                                                        <div class="experience-content">
                                                            <div class="timeline-content">
                                                                ...
                                                                <div class="time"><a class="btn btn-sm btn-primary" href="{{asset($employee->profile->parpo)}}">Download</a></div></a>                                                            
                                                            </div>
                                                        </div>
                                                    </li>
                                                @endif
                                                @if($employee->profile->pecdis)
                                                    <li>
                                                        <div class="experience-user">
                                                            <div class="before-circle"></div>
                                                        </div>
                                                        <div class="experience-content">
                                                            <div class="timeline-content">
                                                                ...
                                                                <div class="time"><a class="btn btn-sm btn-primary" href="{{asset($employee->profile->pecdis)}}">Download</a></div></a>

                                                            </div>
                                                        </div>
                                                    </li>
                                                @endif
                                                @if($employee->profile->pefa)
                                                    <li>
                                                        <div class="experience-user">
                                                            <div class="before-circle"></div>
                                                        </div>
                                                        <div class="experience-content">
                                                            <div class="timeline-content">
                                                                ...
                                                                <div class="time"><a class="btn btn-sm btn-primary" href="{{asset($employee->profile->pefa)}}">Download</a></div></a>                                                            
                                                            </div>
                                                        </div>
                                                    </li>
                                                @endif
                                                @if($employee->profile->ism)
                                                    <li>
                                                        <div class="experience-user">
                                                            <div class="before-circle"></div>
                                                        </div>
                                                        <div class="experience-content">
                                                            <div class="timeline-content">
                                                                ...
                                                                <div class="time"><a class="btn btn-sm btn-primary" href="{{asset($employee->profile->ism)}}">Download</a></div></a>                                                            
                                                            </div>
                                                        </div>
                                                    </li>
                                                @endif
                                                @if($employee->profile->pscrb)
                                                    <li>
                                                        <div class="experience-user">
                                                            <div class="before-circle"></div>
                                                        </div>
                                                        <div class="experience-content">
                                                            <div class="timeline-content">
                                                                ...
                                                                <div class="time"><a class="btn btn-sm btn-primary" href="{{asset($employee->profile->pscrb)}}">Download</a></div></a>                                                            
                                                            </div>
                                                        </div>
                                                    </li>
                                                @endif
                                                @if($employee->profile->pst)
                                                    <li>
                                                        <div class="experience-user">
                                                            <div class="before-circle"></div>
                                                        </div>
                                                        <div class="experience-content">
                                                            <div class="timeline-content">
                                                                ...
                                                                <div class="time"><a class="btn btn-sm btn-primary" href="{{asset($employee->profile->pst)}}">Download</a></div></a>                                                            
                                                            </div>
                                                        </div>
                                                    </li>
                                                @endif
                                                @if($employee->profile->psso)
                                                    <li>
                                                        <div class="experience-user">
                                                            <div class="before-circle"></div>
                                                        </div>
                                                        <div class="experience-content">
                                                            <div class="timeline-content">
                                                                ...
                                                                <div class="time"><a class="btn btn-sm btn-primary" href="{{asset($employee->profile->psso)}}">Download</a></div></a>                                                            
                                                            </div>
                                                        </div>
                                                    </li>
                                                @endif
                                                @if($employee->profile->gdmss)
                                                    <li>
                                                        <div class="experience-user">
                                                            <div class="before-circle"></div>
                                                        </div>
                                                        <div class="experience-content">
                                                            <div class="timeline-content">
                                                                ...
                                                                <div class="time"><a class="btn btn-sm btn-primary" href="{{asset($employee->profile->gdmss)}}">Download</a></div></a>                                                            
                                                            </div>
                                                        </div>
                                                    </li>
                                                @endif
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <select class="select" name="salary_basis">
                                                    <option selected disabled>-- Select salary basis type --</option>
                                        ...
                                        <div class="form-group mb-0 col-sm-4">
                                            ...
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    ...
                                                    <input class="form-control" type="text" name="salary" placeholder="{{number_format($employee->profile->salary, 2)}}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4">  
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="emp_id" placeholder="{{$employee->profile->emp_id}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input id="email" placeholder="{{$employee->email}}" type="email" class="form-control @error('email') is-invalid @enderror" name="email" autocomplete="email" autofocus>
                                                    @error('email')
                                            ...
                                            <div class="col-sm-4">  
                                                <div class="form-group">
                                                    ...
                                                    <div class="cal-icon"><input class="form-control datetimepicker" name="start_date" type="text" placeholder="{{$employee->profile->start_date}}"></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="select" name="category">
                                                        <option class="text-muted" disabled selected style="display: none">Choose a Category...</option>
                                                        @foreach($categories as $category)
                                                            <option value="{{ $category->id }}"
                                                            @if($employee->category->id == $category->id)
                                                            selected
                                                            @endif
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="select" name="department">
                                                        <option class="text-muted" disabled selected style="display: none">Choose a Department...</option>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <option class="text-muted" disabled selected style="display: none">Choose a Position...</option>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="select" name="grade">
                                                <option class="text-muted" disabled selected style="display: none">Choose a Grade...</option>
            ...
            <!-- CV & Offer Letter Modal -->
            <div id="cv_offer_letter" class="modal custom-modal fade" role="dialog">
                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">CV & Offer Letter</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <form method="POST" action="{{route('employee.update', ['id'=>$employee->id]) }}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label class="col-form-label">Offer Letter</label>
                                            <input class="form-control" type="file" name="contract_letter">
                                        </div>
                                    </div>
