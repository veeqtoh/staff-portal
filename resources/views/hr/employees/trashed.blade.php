                        ...
                        <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                            <div class="profile-widget">
                                <div class="profile-img">
                                    <a href="{{route('hr.employee.profile', ['slug'=>$user->slug]) }}" class="avatar"><img src="{{$user->profile->avatar}}" alt=""></a>
                                </div>
                                ...
                                <div class="modal-content">
                                    <div class="modal-body">
                                        ...
                                        <div class="modal-btn delete-action">
                                            <div class="row">
                                                <div class="col-6">
                                                    <a href="{{route('hr.employee.restore', ['id'=>$user->id])}}" class="btn btn-primary continue-btn">Restore</a>
                                                </div>
                                                <div class="col-6">
                                ...
                                <div class="modal-content">
                                    <div class="modal-body">
                                        <div class="form-header">
                                            ...
                                            <p>Only do this if you are very sure. There is no Going Back!</p>
                                            <p><span style="color:red">Warning!</span> This action will delete all employee records including leave and payroll history.</p>
                                        </div>
                                        <div class="modal-btn delete-action">
                                            <div class="row">
                                                <div class="col-6">
                                                    <a href="{{route('hr.employee.kill', ['id'=>$user->id])}}" class="btn btn-primary continue-btn">Yes, Delete</a>
                                                </div>
                                                <div class="col-6">
                                                    <a href="javascript:void(0);" data-dismiss="modal" class="btn btn-primary cancel-btn">Cancel</a>
                                                </div>
