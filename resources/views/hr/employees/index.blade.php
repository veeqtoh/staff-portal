                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto float-right ml-auto">
                            ...
                            <div class="view-icons">
                                <a href="{{route('hr.employees')}}" class="grid-view btn btn-link active"><i class="fa fa-th"></i></a>
                                <a href="{{route('hr.employees.list')}}" class="list-view btn btn-link"><i class="fa fa-bars"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                        <div class="profile-widget">
                            <div class="profile-img">
                                <a href="{{route('hr.employee.profile', ['slug'=>$user->slug]) }}" class="avatar"><img alt="" src="{{$user->profile->avatar}}"></a>
                            </div>
                            <div class="dropdown profile-action">
                                <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="material-icons">more_vert</i></a>
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#edit_employee{{$user->id}}"><i class="fa fa-pencil m-r-5"></i>Quick Edit</a>
                                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete_employee{{$user->id}}"><i class="fa fa-trash-o m-r-5"></i> Disable Account</a>
                                </div>
                            </div>
                            <h4 class="user-name m-t-10 mb-0 text-ellipsis"><a href="{{route('hr.employee.profile', ['slug'=>$user->slug]) }}">{{$user->f_name}} {{$user->l_name}}</a></h4>
                            <h5 class="user-name m-t-10 mb-0 text-ellipsis"><a href="{{route('hr.employee.profile', ['slug'=>$user->slug]) }}">{{$user->category->name}}</a></h5>
                            <div class="small text-muted">{{$user->position->name}}</div>
                            <a href="#!" class="btn btn-white btn-sm m-t-10">Message</a>
                            <a href="{{route('hr.employee.profile', ['slug'=>$user->slug]) }}" class="btn btn-white btn-sm m-t-10">View Profile</a>
                        </div>
                    </div>
                    
                    <!-- Edit Employee Modal -->
                    <div id="edit_employee{{$user->id}}" class="modal custom-modal fade" role="dialog">
                        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title">Edit {{$user->f_name}} {{$user->l_name}}</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                    <form method="POST" action="{{route('employee.update', ['id'=>$user->id]) }}" enctype="multipart/form-data">
                                    @csrf
                                        <div class="row">
                                            <div class="col-sm-4">
                                            ...
                                            <div class="col-sm-6">  
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="emp_id" placeholder="{{$user->profile->emp_id}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input id="email" placeholder="{{$user->email}}" type="email" class="form-control @error('email') is-invalid @enderror" name="email" autocomplete="email" autofocus>
                                                    @error('email')
                                            ...
                                            <div class="col-sm-6">  
                                                <div class="form-group">
                                                    ...
                                                    <div class=""><input class="form-control" name="start_date" type="date" placeholder="{{$user->profile->start_date}}"></div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="submit-section">
                                            <button class="btn btn-primary submit-btn">Update Employee Account</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="modal-content">
                                <div class="modal-body">
                                    ...
                                    <div class="modal-btn delete-action">
                                        <div class="row">
                                            <div class="col-6">
                                                <a href="{{route('hr.employee.delete', ['id'=>$user->id])}}" class="btn btn-primary continue-btn">Disable</a>
                                            </div>
                                            <div class="col-6">
                            ...
                            @csrf
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">  
                                        <div class="form-group">
                                            <label class="col-form-label">Joining Date <span class="text-danger">*</span></label>
                                            <div class=""><input class="form-control" name="start_date" type="date"></div>
                                        </div>
                                    </div>
