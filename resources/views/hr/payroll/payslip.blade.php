@extends('layouts/hr')
    ...
    @section('title')
		<title>{{$payslip->employee->f_name}} {{$payslip->employee->l_name}} Payslip | {{$payslip->month_of->format("F Y")}} - N.U.E Offshore Staff Portal</title>
	@endsection
            ...
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title">{{$payslip->employee->f_name}} {{$payslip->employee->l_name}}'s Payslip</h3>
                            <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('hr.home')}}">Dashboard</a></li>
                                <li class="breadcrumb-item active">{{$payslip->employee->f_name}} {{$payslip->employee->l_name}}'s Payslip</li>
                            </ul>
                        </div>
                                        ...
                                        <div>
                                            ...
                                            <table class="table table-bordered">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><strong>LESS: Total Tax Reliefs</strong> <span class="float-right" style="color:">₦{{number_format($payslip->total_tax_relief, 2)}}</span></td>
                                                    </tr>
                                                    <tr>
                                                        <td><strong>Taxable Pay</strong> <span class="float-right">₦{{number_format($payslip->taxable_pay, 2)}}</span></td>
                                                    </tr>
                                                    <tr>
                                                        <td><strong>PAYE Tax</strong> <span class="float-right" style="color:">₦{{number_format($payslip->paye_tax, 2)}}</span></td>
                                                    </tr>
                                                    <tr>
                                                        <td><strong>Pension Contribution</strong> <span class="float-right" style="color:">₦{{number_format($payslip->pension_contribution, 2)}}</span></td>
                                                    </tr>
                                                    <tr>
                                                        <td><strong>Total Statutory Deductions</strong> <span class="float-right" style="color:">₦{{number_format($payslip->total_statutory_deductions, 2)}}</span></td>
                                                    </tr>
                                                    <tr>
