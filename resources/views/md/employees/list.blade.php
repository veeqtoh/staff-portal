                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto float-right ml-auto">
                            ...
                            <div class="view-icons">
                                ...
                                <a href="{{route('md.employees')}}" class="grid-view btn btn-link"><i class="fa fa-th"></i></a>

                                <a href="{{route('md.employees.list')}}" class="list-view btn btn-link active"><i class="fa fa-bars"></i></a>
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form method="POST" action="{{route('md.employee.store')}}" enctype="multipart/form-data">
